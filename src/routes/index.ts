    ...
    if (req.body.events.length) {
      ...
      if (event.type == 'memberJoined') {
        ...
        await line.replyMessage(replyToken, [
          {
            "type": "text",
            "text": `ยินดีต้อนรับคุณ ${rs.displayName} สู่กลุ่มกิจกรรมพัฒนา รร.วัดระฆังทอง อ.โพธาราม จ.ราชบุรีในวันที่ 21-23 ตุลาคม 66 รายละเอียดเพิ่มเติมจะแจ้งให้ทราบอีกครั้งนึงครับ`
          },
          {
            "type": "text",
